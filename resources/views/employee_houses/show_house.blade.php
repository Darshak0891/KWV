                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="post" action="{{ route('employee_houses.actionpost', $data->id) }}" id="emphsForm">
                                            @csrf
                                            @method('POST')

                                            <input type="text" id="house_no" name="house_no" value="{{ $data->house_no }}" size="5" />

                                    <td> <input type="text" id="name" name="name" value="{{ $data->name }}" size="25" />
                                    </td>
                                    <td> <input type="text" id="mobile_no" name="mobile_no" value="{{ $data->mobile_no }}" size="10" />
                                    </td>
                                    <td> <input type="text" id="box_no" name="box_no" value="{{ $data->box_no }}" size="15" /></td>
                                    ...
                                    <td><input type="text" name="remark" value="{{ $data->remark }}" placeholder="Note" size="9" /></td>

                                    <td> <input type="radio" name="dc" value="1" {{ ($data->dc=="1") ? "checked" : "" }} required="" class="form-check-input">Yes
                                        <input type="radio" name="dc" value="0" {{ ($data->dc=="0") ? "checked" : "" }} required="" class="form-check-input">No
                                    </td>

                                    <td> <input type="radio" name="nod" value="1" {{ ($data->nod=="1") ? "checked" : "" }} required="" class="form-check-input">Yes
                                        <input type="radio" name="nod" value="0" {{ ($data->nod=="0") ? "checked" : "" }} required="" class="form-check-input">No
                                    </td>
