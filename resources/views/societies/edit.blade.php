...
<body>
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Society /</span> Edit Society</h4>
        <div class="card-body">
            @if ($errors->any())
                ...
                <div class="card-body">
                    <form method="post" id="updatesociety" action="{{ route('societies.update', $society->id) }}">
                        <div class="mb-3">
                            ...
                            <input type="text" id="society_name" class="form-control" name="society_name" value="{{ $society->society_name }}" />
                        </div>
                        <br>
