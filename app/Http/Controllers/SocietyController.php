...
class SocietyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Admin_log::create(['user_id' => $user->id,'type_id' => 2, 'action_type_id' => 1, 
    ...
    public function update(Request $request,$id)
    {
        ...
        Admin_log::create(['user_id' => $user->id, 'type_id' => 2, 'action_type_id' => 2,
    ...
    public function delete($id)
    {
        ...
        $society->delete();
        Admin_log::create(['user_id' => $user->id, 'type_id' => 2, 'action_type_id' => 3, 
