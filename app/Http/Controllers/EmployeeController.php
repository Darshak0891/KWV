...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Admin_log::create(['user_id' => $user->id, 'type_id' => 1, 'action_type_id' => 1, 
    ...
    public function update(Request $request,$id)
    {
        ...
        Admin_log::create(['user_id' => $user->id, 'type_id' => 1, 'action_type_id' => 2, 
    ...
    public function delete($id)
    {
        ...
        $employee->delete();
        Admin_log::create(['user_id' => $user->id, 'type_id' => 1, 'action_type_id' => 3, 
    ...
    public function adminlog()
    {
        ...
        ->select('admin_logs.id','admin_logs.type_id','admin_logs.action_type_id','admin_logs.request_id',
        'admin_logs.message','admin_logs.edit_old_data','admin_logs.edit_new_data','users.name')->get();
      //  dd($admin_log);
